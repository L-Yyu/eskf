...
public:
    ...
    void LoadParameters(const std::string &config_file_path) {
        try {
            ...
            init_yaw_ = config_node["init_yaw"].as<double>();
            init_pitch_ = config_node["init_pitch"].as<double>();
            init_roll_ = config_node["init_roll"].as<double>();
            ...
            LOG(INFO) << "init_yaw: " << init_yaw_;
            LOG(INFO) << "init_pitch: " << init_pitch_;
            LOG(INFO) << "init_roll: " << init_roll_;
            LOG(INFO) << std::endl;
        } catch (...) {
